			...
			<div class="wrap">
				...
				<div class="pw_wrap">
					...
					<div class="pw_input_box">
						<input type="password" class="pw_input" id="memberPw" name="memberPw">
					</div>
				...
				<div class="address_wrap">
					...
					<div class="address_input_1_wrap">
						<div class="address_input_1_box">
							<input class="address_input_1" id="memberAddr1" name="memberAddr1" readonly="readonly">
						</div>
					...
					<div class="address_input_2_wrap">
						<div class="address_input_2_box">
							<input class="address_input_2" id="memberAddr2" name="memberAddr2" readonly="readonly">
						</div>
					</div>
					<div class="address_input_3_wrap">
						<div class="address_input_3_box">
							<input class="address_input_3" id="memberAddr3" name="memberAddr3" readonly="readonly">
						</div>
					</div>
...
<script type="text/javascript">
	...
	$(".mail_check_button").click(function() {
		...
		if (mailFormCheck(email)) {
			warnMsg.html("이매일이 전송되었습니다. 이메일을 확인해주세요.");
